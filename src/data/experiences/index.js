...
export default [
  ...
  },
  {
    ...
    date: 2016,
    duration: (
      <FormattedMessage {...messages.yearsDuration} values={{ duration: 2 }} />
    ),
    type: EXPERIENCE_TYPES.education,
  },
  {
  ...
  },
  {
    ...
    date: 2020,
    duration: (
      <FormattedMessage {...messages.monthDuration} values={{ duration: 1 }} />
    ),
  ...
  },
  {
    ...
    story: (
      <FormattedMessage
        {...messages.loyaltyStory}
        values={{
          loyalty: (chunks) => (
            <Link
              to="https://www.loyaltycompany.com"
              target="_blank"
              rel="noopener"
            >
              {chunks}
    ...
    duration: (
      <FormattedMessage
        {...messages.yearDuration}
        values={{ duration: 1.25 }}
      />
    ),
    type: EXPERIENCE_TYPES.freelance,
  },
